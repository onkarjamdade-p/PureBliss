...
import treatment1 from "../assets/PRP.jpg";
import treatment2 from "../assets/GFC.jpg";
import treatment3 from "../assets/MESOTHERAPY.jpg";
import treatment4 from "../assets/LLLT.jpg";
import treatment5 from "../assets/AntiDandruff.jpg";
...
const HAIR_SERVICES = [
    {
        ...
        desc: "Boost Natural Hair Growth",
        img: treatment1,
        summary: "A non-surgical treatment that rejuvenates weak follicles using your own platelets for natural regrowth and thicker strands.",
        benefits: ["Reduces hair fall effectively", "Stimulates new growth", "Improves scalp health naturally"],
    },
    {
        id: 2,
        title: "GFC Treatment",
        tag: "Growth Factor",
        desc: "Advanced Hair Regrowth Solution",
        img: treatment2,
        summary: "Harnesses growth factors from your own blood to stimulate strong, healthy hair follicles for fuller, denser hair.",
        benefits: ["Improves hair density and texture", "Reduces thinning and shedding", "Safe, non-surgical, and effective"],
    },
    {
        id: 3,
        title: "Mesotherapy",
        tag: "Vitamin Nourishment",
        desc: "Vitamin-Rich Hair Nourishment",
        img: treatment3,
        summary: "Delivers essential vitamins and nutrients directly into the scalp to restore hair vitality and strengthen roots.",
        benefits: ["Boosts hair growth naturally", "Improves scalp circulation", "Reduces dandruff and breakage"],
    },
    {
        id: 4,
        title: "LLLT Therapy",
        tag: "Laser Revitalization",
        desc: "Laser Hair Revitalization",
        img: treatment4,
        summary: "A painless laser therapy that energizes dormant follicles, strengthens hair shafts, and promotes thicker hair.",
        benefits: ["Non-invasive and comfortable", "Stimulates weak hair follicles", "Improves scalp health visibly"],
    },
    {
        id: 5,
        title: "Anti-Dandruff",
        tag: "Scalp Therapy",
        desc: "Target Flakes & Scalp Irritation",
        img: treatment5,
        summary: "Advanced scalp therapy designed to eliminate dandruff, reduce itching, and restore a balanced, healthy scalp.",
        benefits: ["Removes dandruff and flakes effectively", "Soothes scalp irritation", "Balances scalp oil and strengthens roots"],
    },
];
    ...
    return (
      ...
      ══════════════════════════════════════════ */}
            <section className="relative overflow-hidden flex flex-col items-center justify-center text-center
                ...
                {/* Video background */}
                <video src="/videos/hair_intro.mp4" autoPlay loop muted playsInline
                ...
                <div className="relative z-10 flex flex-col items-center px-5 py-16 sm:py-24 max-w-2xl">
                    ...
                    >
                        Advanced Hair{" "}
                        <span className="italic" style={{ color: "#b8e8e8" }}>Treatments</span>
                    </motion.h1>
                    ...
                    >
                        Healthy scalp. Natural hair. Advanced care that truly works.
                    </motion.p>
