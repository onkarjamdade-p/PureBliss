...
const hairServices = [
    {
        ...
        details: {
            summary:
                "A non-surgical treatment that rejuvenates weak follicles using your own platelets for natural regrowth and thicker strands.",
            benefits: [
    ...
    },
    {
        ...
        details: {
            summary:
                "Harnesses growth factors from your own blood to stimulate strong, healthy hair follicles for fuller, denser hair.",
            benefits: [
                "Improves hair density and texture",
                "Reduces thinning and shedding",
                "Safe, non-surgical, and effective",
            ],
        },
    },
    {
        ...
        details: {
            summary:
                "Delivers essential vitamins and nutrients directly into the scalp to restore hair vitality and strengthen roots.",
            benefits: [
    ...
    },
    {
        ...
        details: {
            summary:
                "A painless laser therapy that energizes dormant follicles, strengthens hair shafts, and promotes thicker hair.",
            benefits: [
                "Non-invasive and comfortable",
                "Stimulates weak hair follicles",
                "Improves scalp health visibly",
            ],
        },
    },
    {
        ...
        desc: "Target Flakes, Itch & Scalp Irritation",
        img: treatment5,
        details: {
            summary:
                "Advanced scalp therapy designed to eliminate dandruff, reduce itching, and restore a balanced, healthy scalp.",
            benefits: [
                "Removes dandruff and flakes effectively",
                "Soothes scalp irritation",
                "Balances scalp oil and strengthens roots",
            ],
        },
    },
];
