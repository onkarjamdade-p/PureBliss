...
const MAKEUP_SERVICES = [
    {
        ...
        img: treatment1,
        summary: "A semi-permanent tinting procedure that enhances color, symmetry, and definition for naturally fuller lips.",
        benefits: ["Enhances natural lip tone", "Improves lip symmetry", "Long-lasting results (1–2 years)"],
    },
    {
        id: 2,
        ...
        img: treatment2,
        summary: "A Korean-inspired treatment that provides semi-permanent foundation-like coverage with a natural radiant glow.",
        benefits: ["Brightens dull skin instantly", "Reduces pigmentation & spots", "Smooth, even-toned complexion"],
    },
    {
        id: 3,
        ...
        img: treatment3,
        summary: "A cosmetic tattoo technique that creates the illusion of natural hair follicles for fuller-looking hair.",
        benefits: ["Non-surgical and safe", "Instant visible results", "Natural, realistic appearance"],
    },
    {
        id: 4,
        ...
        img: treatment4,
        summary: "Enhance your beauty with a precisely placed mark that adds character and charm to your appearance.",
        benefits: ["Quick, simple, and painless", "Custom placement options", "Lasts for 1–3 years"],
    },
    {
        id: 5,
        ...
        img: treatment5,
        summary: "Creates natural-looking, hair-like strokes for fuller, symmetrical brows using semi-permanent pigments.",
        benefits: ["Perfectly shaped brows", "Smudge-proof and water-resistant", "Saves time on daily makeup"],
    },
];
    ...
    return (
      ...
      ══════════════════════════════════════════ */}
            <section className="relative overflow-hidden flex flex-col items-center justify-center text-center
                ...
                {/* Video background */}
                <video src="/videos/makeup_intro.mp4" autoPlay loop muted playsInline
                ...
                <div className="relative z-10 flex flex-col items-center px-5 py-16 sm:py-24 max-w-2xl">
                    ...
                    >
                        Semi-Permanent{" "}
                        <span className="italic" style={{ color: "#b8e8e8" }}>Makeup</span>
                    </motion.h1>
