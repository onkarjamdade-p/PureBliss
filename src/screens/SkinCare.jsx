...
const SKIN_SERVICES = [
  {
    ...
    img: treatment1,
    summary: "Gently exfoliates dead skin cells to reveal a brighter, smoother complexion and even out skin tone.",
    benefits: ["Reduces pigmentation & acne marks", "Evens skin tone", "Boosts natural glow"],
  },
  {
    id: 2,
    title: "Carbon Peel",
    ...
    img: treatment2,
    summary: "Combines laser precision with a carbon mask for deep pore cleansing, acne control, and instant brightness.",
    benefits: ["Removes impurities and excess oil", "Tightens pores and refines texture", "Promotes a natural, soft glow"],
  },
  {
    id: 3,
    ...
    img: treatment3,
    summary: "Targets unwanted hair follicles with advanced laser energy for silky-smooth skin and lasting results.",
    benefits: ["Safe and pain-free treatment", "Permanent hair reduction", "Effective for all skin types"],
  },
  {
    id: 4,
    ...
    img: treatment4,
    summary: "Combines microneedling with radiofrequency to stimulate collagen production and improve skin texture.",
    benefits: ["Reduces scars and fine lines", "Improves elasticity and firmness", "Smoothens overall skin texture"],
  },
  {
    id: 5,
    ...
    img: treatment5,
    summary: "Harnesses ultrasound energy to lift and firm sagging skin — achieving a youthful appearance without surgery.",
    benefits: ["Non-invasive facelift", "Stimulates collagen and elastin", "Enhances facial contours naturally"],
  },
];
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif" }}
      ...
      <section className="relative overflow-hidden flex flex-col items-center justify-center text-center
        ...
        {/* Video background */}
        <video src="/videos/skin_intro.mp4" autoPlay loop muted playsInline
